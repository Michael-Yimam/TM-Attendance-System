...
values ('November 2018', '2018-11-01', '2018-11-24', 21, 4),
       ...
       ('May 2019', '2019-04-29', '2019-05-23', 22, 4),
...
values ('waanovember2018', 'WAA', 'November 2018', 'tina11'),
       ...
       ('waajune2019', 'WAA', 'June 2019', 'tina11');
...
values ('986957','algofebruary2019'),
       ('986957','semarch2019'),
       ('986957','waanovember2018'),
       ('986960','waanovember2018'),
       ('986959','waanovember2018'),
       ('986950','waanovember2018'),
       ('986950','waanovember2018'),
       ('986954','waanovember2018'),
...
values ('2018-11-01','DB','AM','REGULAR','November 2018'),
       ...
       ('2019-05-27','DB','AM','REGULAR','June 2019'),
       ('2019-05-28','DB','AM','REGULAR','June 2019'),
       ('2019-05-29','DB','AM','REGULAR','June 2019'),
       ('2019-05-30','DB','AM','REGULAR','June 2019'),
       ('2019-05-31','DB','AM','REGULAR','June 2019'),
       ('2019-06-01','DB','AM','REGULAR','June 2019'),
       ('2019-06-03','DB','AM','REGULAR','June 2019'),
       ('2019-06-04','DB','AM','REGULAR','June 2019'),
       ('2019-06-05','DB','AM','REGULAR','June 2019'),
       ('2019-06-06','DB','AM','REGULAR','June 2019'),
       ('2019-06-07','DB','AM','REGULAR','June 2019'),
       ('2019-06-08','DB','AM','REGULAR','June 2019'),
       ('2019-06-10','DB','AM','REGULAR','June 2019'),
       ('2019-06-11','DB','AM','REGULAR','June 2019'),
       ('2019-06-12','DB','AM','REGULAR','June 2019'),
       ('2019-06-13','DB','AM','REGULAR','June 2019'),
       ('2019-06-14','DB','AM','REGULAR','June 2019'),
       ('2019-06-15','DB','AM','REGULAR','June 2019'),
       ('2019-06-17','DB','AM','REGULAR','June 2019'),
       ('2019-06-18','DB','AM','REGULAR','June 2019'),
